...
class LuaScriptInterface
{
	...
	protected:
		...
		static int luaCreatureInCombo(lua_State* L);
		static int luaCreatureDeCombo(lua_State* L);
		static int luaCreatureSetCombo(lua_State* L);
		static int luaCreatureGetCombo(lua_State* L);
