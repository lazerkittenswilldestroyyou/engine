...
//Xor 1
int LuaScriptInterface::luaCreatureInCombo(lua_State* L)
{
	// player:InCombo()
...
int LuaScriptInterface::luaCreatureDeCombo(lua_State* L)
{
	// player:DeCombo()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaCreatureGetCombo(lua_State* L)
{
	// player:GetCombo()
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
...
int LuaScriptInterface::luaCreatureSetCombo(lua_State* L)
{
	// player:setCombo(combo)
	Player* player = getUserdata<Player>(L, 1);
	if (player) {
		int combo = getNumber<int>(L, 2);
		player->setCombo(combo);
		pushBoolean(L, true);
	}
	else {
...
void LuaScriptInterface::registerFunctions()
{
	...
	//Xor
	registerMethod("Creature", "inCombo", LuaScriptInterface::luaCreatureInCombo);
	registerMethod("Creature", "deCombo", LuaScriptInterface::luaCreatureDeCombo);
	registerMethod("Creature", "setCombo", LuaScriptInterface::luaCreatureSetCombo);
	registerMethod("Creature", "getCombo", LuaScriptInterface::luaCreatureGetCombo);
	//
